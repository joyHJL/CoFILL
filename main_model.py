...
class CoFILL_aqi36(CoFILL):
    def __init__(self, config, device, target_dim=36, seq_len=36):
        super(CoFILL_aqi36, self).__init__(target_dim, seq_len, config, device)
        self.config = config
...
class CoFILL_MetrLA(CoFILL):
    def __init__(self, config, device, target_dim=207, seq_len=24):
        super(CoFILL_MetrLA, self).__init__(target_dim, seq_len, config, device)
        self.config = config
...
class CoFILL_PemsBAY(CoFILL):
    def __init__(self, config, device, target_dim=325, seq_len=24):
        super(CoFILL_PemsBAY, self).__init__(target_dim, seq_len, config, device)
        self.config = config
